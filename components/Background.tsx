...
export default function Background({children}:{children: ReactNode}) {
  ...
  return (
    <div className="w-screen h-screen overflow-y-auto overflow-x-hidden">
      <div
        id="spotlight"
        className="font-phantom-sans opacity-25 w-full min-h-full bg-[length:40px_40px] bg-repeat fixed top-0 left-0 z-[-1] bg-[url('https://icons.hackclub.com/api/icons/red/glyph:rep.svg')]"
      >
        <div
